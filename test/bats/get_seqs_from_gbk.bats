...
@test "Testing getSeqsFromGBK: faa" {
    run ./getSequencesFromGbk.py test/data/test.gbk -c -o test/data/test.gbk.faa -f genbank -t
    [ "$status" = 0 ]
...
@test "Testing getSeqsFromGBK: fna" {
    run ./getSequencesFromGbk.py test/data/test.gbk -c -o test/data/test.gbk.fna -f genbank
    [ "$status" = 0 ]
